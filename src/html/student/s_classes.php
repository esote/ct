...
Allow students to select classes,
...
<html lang="en">
	<head>
		...
		<link href="style/chosen/chosen.min.css" rel="stylesheet">
	</head>
	<body>
		<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
			...
			<div class="btn-group right" role="group">
				...
				<a rel="noopener noreferrer" class="btn btn-secondary btn-sm active" href="student/s_classes.php">Classes <span class="sr-only">(current)</span></a>
